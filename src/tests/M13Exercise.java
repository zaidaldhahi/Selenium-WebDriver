...
// Magic code goes here
  ...
  @Test
  public void testM13Exercise() throws Exception {
    ...
    driver.findElement(By.id("datepick_in")).sendKeys("27/09/2018");
    driver.findElement(By.id("datepick_out")).clear();
    driver.findElement(By.id("datepick_out")).sendKeys("28/09/2018");
