...
// Magic code goes here
  ...
  public void testMyFirstWebDriver() throws Exception {
    ...
    driver.findElement(By.xpath(prop.getProperty("Txt_Login_Username"))).sendKeys("zaidtest");
    driver.findElement(By.id(prop.getProperty("Txt_Login_Password"))).clear();
    driver.findElement(By.id(prop.getProperty("Txt_Login_Password"))).sendKeys("zaidtest2018");
