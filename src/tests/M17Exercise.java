...
public class M17Exercise extends HotelApp_BusinessFunctions {
...
// Open Booked Itinerary page 
    driver.findElement(By.linkText(prop.getProperty("Lnk_BookingHotel_BookedItinerary"))).click();
// Type oder number in the search box
